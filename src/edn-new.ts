 ...
 *
 * This function reads an EDN file, parses it using jsedn library,
 * and normalizes result by:
 ...
 *
 * @param filePath - Absolute path to EDN file
 ...
 *
 * This function recursively processes parsed EDN data structure:
